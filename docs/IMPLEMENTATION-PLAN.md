# Euphoriam Stage 1 / V2 — Implementation Plan (Follow This)

**For:** Yashal / backend (+ frontend coordination)  
**Full spec:** [EUPHORIAM-STAGE1-STAGE2-README.md](./EUPHORIAM-STAGE1-STAGE2-README.md)  
**Rule:** Build **data + APIs first**, then wire **prompts** (Nathan: shadow/test DB after basics exist).
...
*See [EUPHORIAM-STAGE1-STAGE2-README.md](./EUPHORIAM-STAGE1-STAGE2-README.md) for full product spec and schemas.*
