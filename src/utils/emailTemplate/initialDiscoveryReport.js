...
const discoveryReportEmail = (userName, generatedBy = "Euphoraum-AI") => {
  return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
    ...
    <title>Your Discovery Report</title>
  </head>
          ...
          <table width="600" cellpadding="0" cellspacing="0" border="0"
            ...
            <tr>
              <td style="font-size: 16px; color: #333333; text-align: center; line-height: 1.6; padding-bottom: 20px;">
                Your personalized <strong>Discovery Report</strong> has been generated by
            ...
            <tr>
              <td style="background-color: #F7F4ED; border-radius: 8px; padding: 20px;
                ...
                📎 <strong>Your Discovery report is attached to this email as a PDF.</strong><br />
...
module.exports = { discoveryReportEmail };
